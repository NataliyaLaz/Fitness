...
extension UIColor {
    ...
    static let specialYellow = #colorLiteral(red: 1, green: 0.831372549, blue: 0, alpha: 1)
    static let specialLightBrown = #colorLiteral(red: 0.6509803922, green: 0.6509803922, blue: 0.6509803922, alpha: 1)
